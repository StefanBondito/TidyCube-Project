...
public class Form_Restock extends javax.swing.JPanel {
    ...
    private void IDKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IDKeyReleased
        try {
            ...
            Buy.setText(df.format(rs.getInt(3)));
            Sell.setText(df.format(rs.getInt(4)));
            Quantity.setText(df.format(rs.getInt(5)));
    ...
    private void Restock1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Restock1ActionPerformed
       ...
       try {
            ...
            if(Integer.parseInt(RQuantity.getText()) > 0){
                temp = temp +  Integer.parseInt(RQuantity.getText()) ;
                 //update database
       ...
       if(flag){
           ...
           if(Desc.getText().equals("Not Found")){
                ...
                Warning.setText("Quantity must be numeric and greater than 0! ");
            }
       }
