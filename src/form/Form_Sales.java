...
public class Form_Sales extends javax.swing.JPanel implements Refresh {
    ...
    private void initComponents() {
        ...
        Confirm1.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        Confirm1.setRadius(20);
                    ...
                    .addGroup(panelBorder1Layout.createSequentialGroup()
                        .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(panelBorder1Layout.createSequentialGroup()
                                ...
                                .addGap(97, 97, 97)
                                .addComponent(Confirm1, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(panelBorder1Layout.createSequentialGroup()
                                .addGap(759, 759, 759)
    ...
    private void Add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add1ActionPerformed
        ...
        if(quantity>inventory){
            ...
            Warning2.setText("*Quantity must be greater than 0");
            Warning2.setVisible(true);
            flag=false;
        }
        ...
        if(flag){
            ...
            String price_new = df.format(price);
            table.addRow(new Object[]{id, desc, quantity_new, price_new});
    ...
    private void Confirm1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Confirm1ActionPerformed
        ...
        for(int i=0; i<table.getRowCount(); i++){
            ...
            int price = Integer.parseInt(table.getValueAt(i, 3).toString().replaceAll(",", "")) ;
    ...
    private swing_new.Button Confirm1;
