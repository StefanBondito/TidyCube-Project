...
public class Form_Inventory extends javax.swing.JPanel {
    ...
    private void InventoryTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_InventoryTableMouseClicked
        ...
        String buy = InventoryTable.getValueAt(selected, 2).toString().replaceAll(",", "");
        String sell = InventoryTable.getValueAt(selected, 3).toString().replaceAll(",", "");
        String quantity = InventoryTable.getValueAt(selected, 4).toString().replaceAll(",", "");
        Buy.setText(buy);
        Sell.setText(sell);
    ...
    private void Remove1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Remove1ActionPerformed
        ...
        int price = Integer.parseInt(InventoryTable.getValueAt(selected, 2).toString().replaceAll(",", ""));
        int quantity = Integer.parseInt(InventoryTable.getValueAt(selected, 4).toString().replaceAll(",", ""));
    ...
    private void Add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add1ActionPerformed
       //Generate ID
        ...
        //add ke table
        String buying_new = df.format(buying);
        String selling_new = df.format(selling);
        String quantity_new = df.format(quantity);
        InventoryTable.addRow(new Object[]{id,Desc.getText(), buying_new, selling_new, quantity_new});
       
        
        //addnambahkan value stock care untuk di home home 
        int price = Integer.parseInt(Buy.getText());
        vStock += (price*(Integer.parseInt(Quantity.getText())));
    ...
    private void Update1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update1ActionPerformed
        ...
        //update stock value
        int oldPrice = Integer.parseInt(InventoryTable.getValueAt(selected, 2).toString().replaceAll(",", ""));
        int oldQuantity = Integer.parseInt(InventoryTable.getValueAt(selected, 4).toString().replaceAll(",", ""));
        
        int price = Integer.parseInt(Buy.getText());
        vStock = vStock - (oldQuantity*oldPrice) + (price*quantity);
        
        //update table
        String buy_new = df.format(Integer.parseInt(Buy.getText()));
        String sell_new = df.format(Integer.parseInt(Sell.getText()));
        String quantity_new = df.format(Integer.parseInt(Quantity.getText()));
        InventoryTable.setValueAt(Desc.getText(), selected, 1);
        InventoryTable.setValueAt(buy_new, selected, 2);
        InventoryTable.setValueAt(sell_new, selected, 3);
        InventoryTable.setValueAt(quantity_new, selected, 4);
    ...
    public void refresh(){
        ...
        try {
            while(rs.next()){
                ...
                String buy = df.format(rs.getInt(3));
                String sell = df.format(rs.getInt(4));
                String quantity = df.format(rs.getInt(5));
                vStock += rs.getInt(3) * rs.getInt(5);
