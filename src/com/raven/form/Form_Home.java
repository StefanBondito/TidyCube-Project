...
public class Form_Home extends javax.swing.JPanel {
    ...
    public Form_Home() {
        ...
        Stock.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/raven/icon/stock.png")), "Total Stock", "Rp. 0"));
        Profit.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/raven/icon/profit.png")), "Total Profit", "Rp. 0"));
        Transaction.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/raven/icon/flag.png")), "Total Transaction", "0 Transactions"));
    ...
    private void initComponents() {
        ...
        Stock = new com.raven.component.Card();
        Transaction = new com.raven.component.Card();
        Profit = new com.raven.component.Card();
    ...
    public com.raven.component.Card Profit;
    public com.raven.component.Card Stock;
    public com.raven.component.Card Transaction;
